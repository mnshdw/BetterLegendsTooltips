...
WorldCombatDialog.prototype.loadFromData = function (_data)
{
    ...
    this.mDialogContainer = dialogLayout.createDialog(allowDisengage ? 'Prepare for Combat' : 'You are being attacked', null, /*Path.GFX + Asset.HEADER_TACTICAL_COMBAT_DIALOG*/null, true, 'dialog-800-720-2');
	...
	{
		var titleLabel = $('<div class="title-label text-font-medium font-color-subtitle">Your scout reports that he has seen the following...</div>');
		rightColumn.append(titleLabel);
...
WorldCombatDialog.prototype.createButtons = function (_allowDisengage, _disengageText)
{
	...
	if(_allowDisengage)
	{
		...
		layout.createTextButton("Engage!", function ()
		{
	...
	else
	{
		...
		footerButtonBar.append(layout);
		layout.createTextButton("To Arms!", function ()
		{
			self.notifyBackendEngageButtonPressed();
		}, '', 1);
	}
